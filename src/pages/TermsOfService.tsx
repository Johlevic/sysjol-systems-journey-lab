              ...
              <div className="space-y-8 text-muted-foreground leading-relaxed">
                <section className="space-y-3">
                  ...
                  <p>
                    ...
                    imparten exclusivamente en{" "}
                    <strong>modalidad virtual</strong> (online), ya sea a través
                    de sesiones en vivo o contenido pre-grabado según se
                    especifique en la descripción del programa.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <p>
                    ...
                    nuestros servicios,{" "}
                    <strong>
                      una vez realizado el pago y/o confirmada la inscripción,
                      no se realizarán devoluciones ni reembolsos de dinero
                    </strong>{" "}
                    bajo ninguna circunstancia. El usuario acepta este término
                    al momento de completar su transacción.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <p>
                    ...
                    ofrecer descuentos promocionales por tiempo limitado. Una
                    vez finalizado el periodo de oferta comunicado (mediante
                    cronómetros o fechas límite),{" "}
                    <strong>
                      el curso volverá automáticamente a su costo inicial
                    </strong>{" "}
                    sin previo aviso. Es responsabilidad del usuario aprovechar
                    la oferta en el tiempo vigente.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <p>
                    ...
                    <strong>
                      estrictamente prohibida su reproducción, distribución,
                      venta o grabación
                    </strong>{" "}
                    sin consentimiento previo por escrito. El acceso es personal
                    e intransferible; el incumplimiento de esta norma causará la
                ...
                <section className="space-y-3">
                  ...
                  <p>
                    ...
                    internet estable y el equipo técnico necesario para seguir
                    los cursos. SysJoL no se hace responsable por fallas
                    externas ajenas a nuestra infraestructura técnica.
                  </p>
                </section>
