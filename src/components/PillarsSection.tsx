import { Server, Compass, FlaskConical } from "lucide-react";

const pillars = [
  {
    icon: Server,
    title: "Systems",
    description: "Diseñamos y construimos infraestructura sólida, backend moderno, APIs escalables e inteligencia artificial aplicada.",
    gradient: "from-primary to-primary/50",
  },
  {
    icon: Compass,
    title: "Journey",
    description: "Acompañamos a las empresas en su transformación digital, desde la idea hasta la automatización en producción.",
    gradient: "from-accent to-accent/50",
  },
  {
    icon: FlaskConical,
    title: "Lab",
    description: "Un espacio de innovación continua donde experimentamos, automatizamos y optimizamos procesos con tecnología de vanguardia.",
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              <div className="absolute -inset-0.5 bg-gradient-to-r opacity-0 group-hover:opacity-100 rounded-2xl blur transition-all duration-500" 
              ...
              <div className="relative h-full card-gradient rounded-2xl border border-border/50 p-8 transition-all duration-500 group-hover:border-primary/30 group-hover:translate-y-[-4px]">
                {/* Icon */}
                <div className={`inline-flex p-4 rounded-xl bg-gradient-to-br ${pillar.gradient} mb-6`}>
